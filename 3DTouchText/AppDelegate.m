...
{
    if ([shortcutItem.type isEqualToString:@"com.ezhenduan.search"])
    {
        //创建通知
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    //创建通知
    NSNotification *notification =[NSNotification notificationWithName:@"tongzhii" object:nil userInfo:nil];
    //通过通知中心发送通知
    [[NSNotificationCenter defaultCenter] postNotification:notification];
}
